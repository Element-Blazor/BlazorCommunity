...
namespace Blazui.Community.App.Configuration
{
    ...
    {
        public static void AddIdenittyAuthorization<TUser, TDbContext>(this IServiceCollection services) where TUser : IdentityUser<string> where TDbContext : DbContext
        {

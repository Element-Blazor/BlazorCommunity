...
namespace BlazorCommunity.IdentityExtensions
{
    public class CustomIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError InvalidUserName(string userName) { return new IdentityError { Code = "UserName", Description = $"用户名 '{userName}' 错误，只可以包含数字、字母以及@.！" }; }

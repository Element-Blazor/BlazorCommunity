...
namespace BlazorCommunity.Admin.Service
{
    public class AdminUserService : AdminUserServiceBase<IdentityUser, IdentityRole>
    {
        ...
        public AdminUserService(UserManager<IdentityUser> userManager, AuthenticationStateProvider AuthenticationStateProvider,SignInManager<IdentityUser> signInManager, RoleManager<IdentityRole> roleManager, DbContext dbContext) : base(signInManager, roleManager, dbContext)
        {

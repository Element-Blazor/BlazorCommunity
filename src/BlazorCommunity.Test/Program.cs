...
namespace BlazorCommunity.Test
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            //using (BlazorCommunityAdminDbContext communityContext = new BlazorCommunityAdminDbContext())
            //{
            //    communityContext.Database.EnsureDeleted();
            //    communityContext.Database.EnsureCreated();
            //}
            //////string id = Guid.NewGuid().ToString();
            //using (BlazorCommunityContext communityContext = new BlazorCommunityContext())
            //{

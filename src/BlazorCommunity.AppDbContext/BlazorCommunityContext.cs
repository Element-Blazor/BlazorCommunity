...
namespace BlazorCommunity.AppDbContext
{
    public partial class BlazorCommunityContext : IdentityDbContext<BZUserModel, IdentityRole<string>, string>
    {
        public BlazorCommunityContext()
        {
        }

        public BlazorCommunityContext(DbContextOptions<BlazorCommunityContext> options)
            : base(options)
        {
        }
